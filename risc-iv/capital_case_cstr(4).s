.data
buf_data:             .byte  '________________________________'   
buf_size:             .word  0x20                                 ; Размер буфера = 32
in_stop_char:         .word  '\n'                                 ; Символ окончания ввода 
ascii_offset:         .word  0x20                                 ; Разница между строчной и прописной буквой в ASCII
ascii_low_start:      .word  0x60                                 ; 'a' (97) для проверки диапазона
ascii_low_end:        .word  0x7a                                 ; 'z' (122)
ascii_up_start:       .word  0x40                                 ; 'A' (65) для проверки диапазона
...
capitalize_recursive:
    ...
    sub     t0, t0, s1                   ; Строчка -> прописная
...
inside_word:
    ...
    add     t0, t0, s1                   ; Прописная -> строчная
